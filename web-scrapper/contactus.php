...
if (!$con) {
    ...
    // Submit this to Database
            ...
            $sql = "INSERT INTO `conc` (`name`, `email`, `phone`) VALUES ('$name', '$email', '$phone');";
...
<div class="container">
    <form action="/miniproj/contactus.php" method = "post">
        ...
        <!-- <div class="suggestions">
            ...
            <textarea name="suggestions" id="suggestions" rows="8" cols="50" placeholder="Enter suggestions here" required ></textarea>
        </div> -->
        <div class="but">
